...
gphoto2 --capture-image --hook-script=/home/pi/Fotokiste/Fotobox_hook.sh --filename="Fotobox-%Y-%m-%d--%H-%M-%S.%C" --force-overwrite #Foto wird gemacht angezeigt und runtergeladen
